...
export default class Login {
  ...
  handleSubmitAdmin = e => {
    ...
    const user = {
      type: "Admin",
      email: e.target.querySelector(`input[data-testid="admin-email-input"]`).value,  // Bug ici
      password: e.target.querySelector(`input[data-testid="admin-password-input"]`).value, // Bug ici
      status: "connected"
    }
    this.localStorage.setItem("user", JSON.stringify(user))
    this.login(user)
